...
int texId[2]; //A créer en même temps que toutes les variables. La taille depend du nombre de textures
...
void load_textures(void) {
    ...
    if ( !(texId[2] = loadBMPTexture("textures/bat2.bmp"))){
        /* Gestion de l'erreur */
...
void createCity()
{
    ...
    glPushMatrix();
    glBegin(GL_POLYGON);
    glTexCoord2i(1,1);		glVertex3f(100,100,0);
    glTexCoord2i(1,0);		glVertex3f(100,-100,0);
    glTexCoord2i(0,0);		glVertex3f(-100,-100,0);
    glTexCoord2i(0,1);      glVertex3f(-100,100,0);
    glEnd();		
